...
{
    public class PurcharseOrderDetailsVM : ViewModelBase
    {
        #region Services
        ...
        public PurcharseOrderDetailList CheckCollections
        {
            get { return GetProperty(() => CheckCollections); }
            set { SetProperty(() => CheckCollections, value); }
        }
        public PurcharseOrderDetail SelectedItem
        {
        ...
        public PurcharseOrderDetailsVM()
        {
        ...
        public void SearchCore()
        {
            ...
            CheckCollections = new PurcharseOrderDetailList(startDate: StartDate, endDate: EndDate);
            CheckCollections = new PurcharseOrderDetailList(
                            CheckCollections
        ...
        public void OnMouseDoubleClick()
        {
            ...
            string documentId = SelectedItem.PoNo;
            IDocument document = FindDocument(documentId);
            if (document == null)
            {
                document = DocumentManagerService.CreateDocument("PurcharseOrderView", new DocumentParamter(EntityMessageType.Changed, SelectedItem), this);
