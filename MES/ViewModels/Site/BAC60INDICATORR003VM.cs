...
{
    public class BAC60INDICATORR003VM : ViewModelBase
    {
        #region Services
        ...
        public void CreateChart()
        {
            DispatcherService.BeginInvoke(() => {
                try
                {
                    ...
                    Avg = Collection.Average(o => o.Yield);
                    ...
                    // 최소 50개
                    for (int i = 0; i < 50 - Collection.Count(); i++)
                    {
                        ChartDataSource.Add(
                            new SeriesItem
                            {
