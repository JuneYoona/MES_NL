...
{
    public class BAC60INDICATORR001VM : ViewModelBase
    {
        #region Services
        ...
        public BAC60INDICATORR001VM()
        {
            ...
            // 공정정보
            WaCollection = new CommonWorkAreaInfoList("BAC60").Where(u => u.WaCode == "WE20" || u.WaCode == "WE30");
        ...
        {
            Collection = new QualityResultTable(ItemCode, StartDate, EndDate, "LQC").Collections;
        }
